...
var file = cljs.core.get.call(null,map__12430__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12430__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12430__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e12429){var _e = e12429;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___12432 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___12432)){
var seen_errors_12433 = temp__5733__auto___12432;
if(cljs.core.truth_(seen_errors_12433.has(self))){
} else {
seen_errors_12433.add(self);

var temp__5735__auto___12434 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___12434)){
var sense_12435 = temp__5735__auto___12434;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12435)].join(''));
} else {
}
}
} else {
