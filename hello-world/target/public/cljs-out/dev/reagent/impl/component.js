...
if((i < len)){
var k = (ks[i]);
var G__8793 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__8794 = (i + (1));
m = G__8793;
i = G__8794;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__8796 = c;
var G__8796__$1 = (((G__8796 == null))?null:G__8796.prototype);
if((G__8796__$1 == null)){
return null;
} else {
return G__8796__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__8798 = c;
var G__8798__$1 = (((G__8798 == null))?null:G__8798.prototype);
if((G__8798__$1 == null)){
return null;
} else {
return G__8798__$1.render;
}
})() == null)))));
});
...
while (G__8802__i < G__8802__a.length) {G__8802__a[G__8802__i] = arguments[G__8802__i + 0]; ++G__8802__i;}
  args = new cljs.core.IndexedSeq(G__8802__a,0,null);
} 
...
var G__8805 = c;
var G__8805__$1 = (((G__8805 == null))?null:G__8805.constructor);
if((G__8805__$1 == null)){
return null;
} else {
return G__8805__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__8806 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__8807 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__8807);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__8806);
}});
...
var c = this;
var G__8811_8813 = goog.object.get(c,"cljsRatom");
if((G__8811_8813 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__8811_8813);
}
...
var renders_8814 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_8815 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_8814));
...
if((cljs.core.count.call(null,renders_8814) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_8814))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_8815)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_8815)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__8816 = o;
goog.object.set(G__8816,cljs.core.name.call(null,k),v);
