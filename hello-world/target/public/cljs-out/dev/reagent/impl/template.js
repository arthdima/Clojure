...
var G__8829 = o;
goog.object.set(G__8829,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__8831__i < G__8831__a.length) {G__8831__a[G__8831__i] = arguments[G__8831__i + 0]; ++G__8831__i;}
  args = new cljs.core.IndexedSeq(G__8831__a,0,null);
} 
...
var G__8833 = o;
goog.object.set(G__8833,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__8837 = props;
var G__8837__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__8837,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8837);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__8837__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__8837__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__8838 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__8838,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__8838;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__8839){
...
var on_write = cljs.core.get.call(null,map__8840__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__8842_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__8842_SHARP_);
}));
} else {
return null;
}
...
var vec__8845 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__8845,(0),null);
var id = cljs.core.nth.call(null,vec__8845,(1),null);
var className = cljs.core.nth.call(null,vec__8845,(2),null);
...
var temp__5739__auto___8849 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___8849 == null)){
} else {
var key_8850 = temp__5739__auto___8849;
(jsprops.key = key_8850);
}
...
var temp__5739__auto___8851 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___8851 == null)){
} else {
var key_8852 = temp__5739__auto___8851;
(jsprops.key = key_8852);
}
...
var temp__5739__auto___8853 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___8853 == null)){
} else {
var key_8854 = temp__5739__auto___8853;
(jsprops.key = key_8854);
}
...
var G__8856 = n;
if(cljs.core._EQ_.call(null,"",G__8856)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__8856)){
return x;
} else {
...
var len__4736__auto___8859 = arguments.length;
var i__4737__auto___8860 = (0);
while(true){
if((i__4737__auto___8860 < len__4736__auto___8859)){
args__4742__auto__.push((arguments[i__4737__auto___8860]));

var G__8861 = (i__4737__auto___8860 + (1));
i__4737__auto___8860 = G__8861;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq8857){
var G__8858 = cljs.core.first.call(null,seq8857);
var seq8857__$1 = cljs.core.next.call(null,seq8857);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8858,seq8857__$1);
}));
...
break;
default:
var G__8864 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__8864;
continue;
...
var ctx = ({});
var vec__8866 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__8866,(0),null);
var derefed = cljs.core.nth.call(null,vec__8866,(1),null);
...
var G__8869 = (cljs.core.count.call(null,argv) - first_child);
switch (G__8869) {
case (0):
